            ...
            else
            {
                ...
                try
                {
                    ...
                    var thread = new Thread(() =>
                    {
                        ...
                        query += "CREATE TABLE [dbo].[LastTimeArticles]([id] [int] identity(1,1) NOT NULL,[ArticleId] [int] NOT NULL,[Name] [nvarchar] (600) NOT NULL,[UnitId] [int] NOT NULL,[QuantityLeft] [int] NULL,[TotalPrice] [int] NULL,[CreationDate] [datetime2](7) NOT NULL)ON [PRIMARY];";
