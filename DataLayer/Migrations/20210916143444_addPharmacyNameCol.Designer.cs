...
namespace DataLayer.Migrations
{
    ...
    [Migration("20210916143444_addPharmacyNameCol")]
    partial class addPharmacyNameCol
    {
            ...
            modelBuilder.Entity("DataLayer.Tables.Account", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        ...
                        .HasDefaultValue(new DateTime(2021, 9, 16, 17, 34, 43, 484, DateTimeKind.Local).AddTicks(342));
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CategoryId = 1,
                            CreationBy = 2,
                            CreationDate = new DateTime(2021, 9, 16, 17, 34, 43, 501, DateTimeKind.Local).AddTicks(9858),
                            General = true,
                            Name = "الحساب العام"
                        },
                        new
            ...
            modelBuilder.Entity("DataLayer.Tables.AccountCategory", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 16, 17, 34, 43, 485, DateTimeKind.Local).AddTicks(323));
            ...
            modelBuilder.Entity("DataLayer.Tables.ArticleCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreationBy = 2,
                            CreationDate = new DateTime(2021, 9, 16, 17, 34, 43, 494, DateTimeKind.Local).AddTicks(350),
                            Name = "أدوية"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("DataLayer.Tables.Barcode", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 16, 17, 34, 43, 492, DateTimeKind.Local).AddTicks(129));
            ...
            modelBuilder.Entity("DataLayer.Tables.BillDetail", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 16, 17, 34, 43, 487, DateTimeKind.Local).AddTicks(269));
            ...
            modelBuilder.Entity("DataLayer.Tables.Branch", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 16, 17, 34, 43, 490, DateTimeKind.Local).AddTicks(189));
            ...
            modelBuilder.Entity("DataLayer.Tables.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreationBy = 2,
                            CreationDate = new DateTime(2021, 9, 16, 17, 34, 43, 499, DateTimeKind.Local).AddTicks(9911),
                            Location = "Damascus",
            ...
            modelBuilder.Entity("DataLayer.Tables.EntryDetail", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 16, 17, 34, 43, 489, DateTimeKind.Local).AddTicks(491));
            ...
            modelBuilder.Entity("DataLayer.Tables.EntryMaster", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 16, 17, 34, 43, 488, DateTimeKind.Local).AddTicks(383));
            ...
            modelBuilder.Entity("DataLayer.Tables.UnitType", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2021, 9, 16, 17, 34, 43, 491, DateTimeKind.Local).AddTicks(155));
